...
| Kode | Penjelasan |
|---|---|
| `.stats-container { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; }` | Class ini mengatur pembungkus kartu ringkasan (di halaman Beranda) memakai CSS Grid dengan 3 kolom yang lebarnya sama rata, plus jarak antar kartu |
